...
import { Card, CardContent, CardHeader, CardTitle, Input } from '@/dashboard/components/ui/Primitives';
...
export const FinanceTab: React.FC = () => {
  ...
  const [clientsPerDay, setClientsPerDay] = useState<number>(8);
  ...
  }, [avgPrice, clientsPerDay, daysPerWeek]);
        ...
        <CardContent className="flex items-start gap-4 p-4">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-400 mt-1 leading-relaxed">
              ...
              sem precisar atender nenhum cliente a mais. Valorize seu trabalho!
            </p>
          </div>
        </CardContent>
      </Card>
