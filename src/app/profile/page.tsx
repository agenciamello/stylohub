...
interface ActionButtonProps {
  ...
  label: string;
  href?: string; // se existir, será um Link
  onClick?: () => void; // se existir, será uma ação
  variant?: 'default' | 'danger';
}

const ActionButton: React.FC<ActionButtonProps> = ({ icon, label, href, onClick, variant = 'default' }) => {
