  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col relative">
      ...
      <header className="relative px-6 pt-14 pb-10">
        ...
        <div className="text-center space-y-2">
          <p className="text-gray-200 text-lg font-medium">
            Bem-vindo de volta, <span className="text-amber-400 font-semibold">@BarbeiroDoStylo!</span>
          </p>
          <div className="flex items-center justify-center space-x-2">
            <Star className="w-4 h-4 text-amber-400 fill-amber-400" />
            <p className="text-gray-300 text-sm italic">
              Pronto para um dia em grande estilo?
            </p>
            <Star className="w-4 h-4 text-amber-400 fill-amber-400" />
          </div>
        </div>
      ...
      <main className="relative flex-1 px-6 pb-24 space-y-6 overflow-y-auto">
        {/* Seu Próximo Atendimento - Super Luxuoso */}
        ...
        {/* Seu Dia em Números - Ultra Premium */}
        <section className="relative">
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-gray-800/80 to-gray-900/80 rounded-2xl p-5 text-center border border-green-500/20">
                  {/* Gráfico circular de progresso - Animado */}
              ...
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-gray-800/80 to-gray-900/80 rounded-2xl p-5 text-center border border-amber-500/20">
                  ...
                  <p className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-amber-400 to-amber-500 font-bold text-2xl mb-1">
                    R$ 350,00
                  </p>
        ...
        {/* Continue Evoluindo - Master Class */}
        <section className="relative">
      ...
      {/* Barra de Navegação Inferior - Ultra Luxuosa */}
      <nav className="relative fixed bottom-0 left-0 right-0 bg-gradient-to-t from-black via-gray-900 to-black border-t border-amber-500/30 backdrop-blur-xl">
        ...
        <div className="grid grid-cols-4 py-3">
          ...
          <button className="flex flex-col items-center py-2 space-y-1 group">
            <GraduationCap href="/academy" className="w-5 h-5 text-gray-400 group-hover:text-amber-400 group-hover:scale-110 transition-all" />
            <span className="text-xs text-gray-400 group-hover:text-amber-400 transition-colors"><a href="/academy">Academy</a></span>
          </button>
